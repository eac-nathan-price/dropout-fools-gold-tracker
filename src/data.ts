...
export const viewData: ViewData = {
    ...
    videos: {
        "peel-robalino": {
            youtube: [0, 50000, 78000, 113000, 130000, 151000, 158000, 166000, 171000],
            tiktok: [0, 61700, 84300, 108800, 125600, 148000, 154900, 162000, 165700],
            instagram: [0, 148000, 296000, 509000, 537000, 570000, 581000, 591000, 596000]
        },
        "annas-king": {
            youtube: [0, 70000, 118000, 218000, 261000, 312000, 328000, 356000, 368000],
            tiktok: [0, 127400, 255500, 354800, 391600, 435400, 456400, 473500, 482500],
            instagram: [0, 114000, 229000, 396000, 428000, 466000, 482000, 505000, 517000]
        },
        "katies-d20": {
            youtube: [0, 201000, 403000, 636000, 709000, 804000, 841000, 878000, 901000],
            tiktok: [0, 338900, 545200, 726200, 797300, 868000, 894400, 925200, 942800],
            instagram: [0, 229000, 458000, 797000, 873000, 995000, 1000000, 1000000, 1000000]
        },
        "erikas-haircut": {
            youtube: [0, 189000, 364700, 492000, 555000, 626000, 650000, 676000, 691000],
            tiktok: [0, 103700, 145800, 181500, 199000, 219600, 227600, 235900, 240100],
            instagram: [0, 113000, 226000, 390000, 415000, 442000, 451000, 460000, 466000]
        },
        "sephies-car-wash": {
            youtube: [0, 66000, 102000, 145000, 165000, 194000, 201000, 210000, 216000],
            tiktok: [0, 73700, 97600, 122900, 136300, 150300, 155600, 160900, 163900],
            instagram: [0, 162000, 323000, 553000, 585000, 625000, 638000, 651000, 659000]
        },
        "grants-crack": {
            youtube: [0, 53000, 79000, 111000, 124000, 140000, 145000, 151000, 156000],
            tiktok: [0, 64100, 97900, 136200, 155300, 179400, 190300, 201100, 206100],
            instagram: [0, 86000, 172000, 296000, 314000, 331000, 337000, 342000, 346000]
        },
        "jonnys-puppy-bowl": {
            youtube: [0, 46000, 71000, 104000, 117000, 134000, 139000, 145000, 148000],
            tiktok: [0, 89600, 130700, 165400, 178400, 192500, 197300, 201900, 204500],
            instagram: [0, 68000, 136000, 234000, 251000, 266000, 271000, 277000, 280000]
        },
        "lily-izzys-milk": {
            youtube: [0, 66000, 107000, 158000, 181000, 208000, 217000, 226000, 233000],
            tiktok: [0, 292000, 422800, 570100, 636700, 696600, 725500, 765700, 787300],
            instagram: [0, 420000, 840000, 1500000, 1700000, 2000000, 2100000, 2200000, 2200000]
        },
        "izzys-buttholes": {
            youtube: [0, 186000, 372000, 654000, 769000, 912000, 957000, 1000000, 1000000],
            tiktok: [0, 90300, 125200, 167500, 189500, 206700, 210800, 214700, 217100],
            instagram: [0, 114000, 227000, 392000, 424000, 453000, 465000, 475000, 481000]
        },
        "vics-brennans-exit": {
            youtube: [0, 415000, 825000, 1300000, 1600000, 1800000, 1900000, 1900000, 2000000],
            tiktok: [0, 881200, 1500000, 1900000, 2100000, 2200000, 2300000, 2300000, 2400000],
            instagram: [0, 540000, 1080000, 1800000, 2000000, 2200000, 2200000, 2300000, 2300000]
        }
    }
};
